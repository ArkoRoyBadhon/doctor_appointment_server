...
router.get("/:id", auth_1.isAuthenticatedUser, (0, auth_1.authorizeRoles)("admin", "patient", "doctor"), appointment_controller_1.getAppointmentByIdController);
router.put("/update/:id", auth_1.isAuthenticatedUser, (0, auth_1.authorizeRoles)("admin", "patient"), appointment_controller_1.updateAppointmentController);
...
router.get("/patient/appointments", auth_1.isAuthenticatedUser, (0, auth_1.authorizeRoles)("patient"), appointment_controller_1.getAllAppointmentsByUserController);
